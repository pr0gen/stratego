...
impl StrategoError {
    pub fn message(&self) -> String {
        match self {
            StrategoError::MoveError(case, coordinate) => {
            ...
            StrategoError::PlacementError(x, y, piece) => {
                format!("Can not place piece {:?} to ({}, {})", piece.get_rank(), x, y)
            }
